...
<div id="content">
    ...
    <div class="mid" style="margin-top:20px">
        ...
        <ul class="task-menu" style="width: 200px;">
            ...
            <li><a onclick="ajax('form','modules/guild_edit.php','guild_id=<?php echo $guild->attrs['id']?>',true)">Promote / Demote</a></li>
            <li><a onclick="ajax('form','modules/guild_comments.php','guild_id=<?php echo $guild->attrs['id']?>',true)">Edit Description</a></li>
            <li><a onclick="ajax('form','modules/guild_pass_leadership.php','guild_id=<?php echo $guild->attrs['id']?>',true)">Pass Leadership</a></li>
            <li><a onclick="if(confirm('Are you sure?')){ajax('form','modules/guild_disband.php','guild_id=<?php echo $guild->attrs['id']?>',true);}">Disband guild</a></li>
                    <?php }//is owner
                    if (!isset($account)) {?>
